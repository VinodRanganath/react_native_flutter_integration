...
import 'module_integration_model.dart';
export 'module_integration_model.dart';

class ModuleIntegrationWidget extends StatefulWidget {
  const ModuleIntegrationWidget({super.key});

  @override
  State<ModuleIntegrationWidget> createState() =>
      _ModuleIntegrationWidgetState();
}

class _ModuleIntegrationWidgetState extends State<ModuleIntegrationWidget> {
  late ModuleIntegrationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ModuleIntegrationModel());
